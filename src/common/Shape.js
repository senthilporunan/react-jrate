...
export default class Shape extends React.Component {
	...
	render()  {
            var header = '<svg width="' + this.props.settings.width + '" height=' + this.props.settings.height + 
            ' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style=' + this.props.style +'"  ';
            var hz = this.props.settings.horizontal;
			var id = this.props.id;
            var linearGrad = '<defs><linearGradient id="'+id+'_grad'+this.props.idx+'" x1="0%" y1="0%" x2="' + (hz ? 100 : 0) + '%" y2="' + (hz ? 0 : 100) + '%">' +
                '<stop offset="0%"  stop-color=' + this.props.settings.backgroundColor + '></stop>' +
                '<stop offset="0%" stop-color=' + this.props.settings.backgroundColor + '></stop>' +
                '</linearGradient></defs>';
            var shapeRate;
            switch (this.props.settings['shape']) {
                ...
                case 'CIRCLE':
                    ...
                    break;
                case 'RECTANGLE':
                    shapeRate = header + '>' + linearGrad + '<rect width="' + this.props.settings.width + '" height="' + this.props.settings.height + '" fill="url(#'+id+'_grad'+this.props.idx+')" style="stroke:' + this.props.settings.strokeColor + ';fill-opacity:' + +this.props.settings.transparency + ';stroke-width:' + this.props.settings.strokeWidth + ';"></rect>' +
                        '</svg>';
                    break;
                case 'TRIANGLE':
                    shapeRate = header + '>' + linearGrad +
                        '<polygon points="' + this.props.settings.width / 2 + ',0 0,' + this.props.settings.height + ' ' + this.props.settings.width + ',' + this.props.settings.height + '" fill="url(#'+id+'_grad'+this.props.idx+')" style="stroke:' + this.props.settings.strokeColor + ';fill-opacity:' + +this.props.settings.transparency + ';stroke-width:'+ this.props.settings.strokeWidth + ';"></polygon>' +
                        '</svg>';
                    break;
                case 'RHOMBUS':
				...
				case 'FOOD':
					...
					'<path fill="url(#'+id+'_grad'+this.props.idx+')" style="stroke:' + this.props.settings.strokeColor + ';fill-opacity:' + +this.props.settings.transparency + ';"' + 
				...
				case 'TWITTER':
					...
					'<path fill="url(#'+id+'_grad'+this.props.idx+')" style="stroke:' + this.props.settings.strokeColor + ';fill-opacity:' + +this.props.settings.transparency + ';stroke-width:0.7px;"' + 
				...
				case 'BULB':
					shapeRate = header + 'viewBox="0 0 512 512"' + '>' + linearGrad + 
					'<path fill="url(#'+id+'_grad'+this.props.idx+')" style="stroke:' + this.props.settings.strokeColor + ';fill-opacity:' + +this.props.settings.transparency + ';stroke-width:0.7px;"' + 'd="M384,192c0,64-64,127-64,192H192c0-63-64-128-64-192c0-70.688,57.313-128,128-128S384,121.313,384,192z M304,448h-96'+
